...
FlutterStandardTypedData * redThresholdS(NSString * pathString, double minThresholdValue) {
    ...
    if (puedePasar) {
        ...
        cv::inRange(hlsImage, cv::Scalar(0, minThresholdValue, 100), cv::Scalar(30, 255, 255), mask1);
        cv::inRange(hlsImage, cv::Scalar(150, minThresholdValue, 100), cv::Scalar(180, 255, 255), mask2);
