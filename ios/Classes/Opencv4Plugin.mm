...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  // Note: this method is invoked on the UI thread.
    ...
    //Module: Miscellaneous Image Transformations
        ...
        [RedThresholdFactory processWhitPathType:pathType pathString:pathString data:data minThresholdValue:minThresholdValue algorithm:algorithm result:result];
        ...
        [GreenThresholdFactory processWhitPathType:pathType pathString:pathString data:data minThresholdValue:minThresholdValue algorithm:algorithm result:result];
    }
